    ...
    def wfPlotMenu(self):
        ...
        while inputloop == False:
            ...
            if start_answer == '1':
                ...
                clear_screen()
                self.wfPlotBuild(True, self.title)
                inputloop = True
...
class WordFrequency:
    ...
    def createWordFreqValues(self,arglist,searchWords,conn):
        ...
        for w in search_words:
                ...
                for r in v:
                    for kk,vv in r.items():
                        ...
                        if y_total > 0:
                            ...
                            by = by + y_total
                xlist1.append(k)
                ylist1.append(ry/float(datedict[k]))
                xlist2.append(k)
                ylist2.append(by/float(datedict[k]))
            ...
            new_value_set = sorted(value_set.items(), key=itemgetter(1), reverse=False)
